      ...
      <div className="container px-2 md:px-0 mt-[50px]">
        ...
        <div className="rounded-3xl w-[100%] md:h-[84vh] z-[1] relative">
            <div className="absolute w-[100%] flex justify-start items-center py-5 px-4 md:px-10 z-[3]">
              ...
              <div className="w-[6px] h-[6px] bg-darkGrey rounded-full mx-3"></div>
              <Button text="Lifestyle" padding="px-[20px]" onClick={handleClick} bg={aboutType === "Lifestyle" ? "bg-white text-darkGrey" : "bg-grey text-white"}/>
            </div>
