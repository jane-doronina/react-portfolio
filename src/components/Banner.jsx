...
const Banner = () => (
  <header className="pt-[40px] md:pt-[80px] relative overflow-x-hidden z-[20]">
    <div className='container px-6 md:px-0 flex flex-col md:flex-row md:items-center md:justify-between'>
      ...
      <img src={avatar} alt="Jane Doronina photo" className="hidden md:block absolute right-[-20px] bottom-[-130px] z-[0] rounded-full md:rounded-none md:static w-[220px] h-[220px] md:w-[480px] md:h-[520px] object-top object-cover z-[999]"/>
    </div>
